...
def extract_gcc(_FFT,_res, _output,_bar):
    ...
    #TIME
    #---------------------------------------
    time = np.arange(0,3,1)# per le prove
...
# location of data.
folds_list = [1, 2, 3, 4]
evaluation_setup_folder = '../TUT-sound-events-2017-evaluation/evaluation_setup'
audio_folder = '../TUT-sound-events-2017-evaluation/audio/street'

# Output
feat_folder = 'feat_evaluation/'
...
evaluate_file = os.path.join(
    evaluation_setup_folder, 'street_evaluate.txt')

desc_dict = load_desc_file(evaluate_file)
...
evaluate_file = os.path.join(evaluation_setup_folder, 'street_evaluate.txt')
...
if not is_mono:
    # 120
    if '120' in RESOLUTIONS:
        X_test_GCC_120, Y_test_GCC_120 = None, None
    # 240
    if '240' in RESOLUTIONS:
        X_test_GCC_240, Y_test_GCC_240 = None, None
    # 480
    if '480' in RESOLUTIONS:
        X_test_GCC_480, Y_test_GCC_480 = None, None
