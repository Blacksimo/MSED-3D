...
def get_model(data_in_mbe, data_out, _cnn_nb_filt, _cnn_pool_size_mbe, _rnn_nb, _fc_nb, _nb_ch):
...
for fold in [1, 2, 3, 4]:
    ...
    model = get_model(X_MBE, Y, cnn_nb_filt, cnn_pool_size_mbe, rnn_nb, fc_nb, nb_ch)
    ...
    hist = model.fit(
            ...
            validation_data=[X_test_MBE, Y_test],
            epochs=5,
            verbose=1,
